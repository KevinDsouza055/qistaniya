    ...
    <section className="section-pad bg-charcoal-900 relative">
      ...
      <div className="site-container">
        ...
        <div className="section-heading">
          ...
          <p className="text-cream/50 mt-4 text-sm sm:text-base max-w-md mx-auto" style={{ fontFamily: 'Raleway, sans-serif' }}>
            ...
            <div key={dish.id} className="menu-card glass gold-border rounded-sm overflow-hidden group">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-2">
                  <h3
                    className="text-cream font-serif text-lg font-semibold leading-tight pr-2"
                ...
                <div className="flex items-center justify-between">
                  <span className="gold-text font-serif text-2xl font-bold" style={{ fontFamily: 'Playfair Display, serif' }}>
                    ₹{dish.price}
                  </span>
                  <button
                    onClick={() => {
                    ...
                    className="w-10 h-10 rounded-sm flex items-center justify-center transition-all duration-200 hover:scale-110"
        ...
        <div className="text-center mt-16">
          <Link href="/menu" className="btn-outline inline-block px-12 py-4 text-sm">
            View Full Menu
          </Link>
        </div>
      </div>
