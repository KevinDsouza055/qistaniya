...
export default function ReviewsSection() {
  return (
    <section className="pt-40 pb-64 sm:pt-64 sm:pb-[25vh] bg-charcoal-950 relative overflow-hidden">
      ...
      <div className="site-container relative z-10 px-8 sm:px-12 max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-32 sm:mb-56 text-center">
        ...
        {/* Card Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 sm:gap-24 lg:gap-32">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="group relative flex flex-col h-full glass gold-border rounded-[4rem] sm:rounded-[6rem] p-14 sm:p-28 transition-all duration-700 hover:-translate-y-6 hover:border-gold-300 hover:shadow-[0_50px_100px_rgba(212,168,67,0.15)] overflow-hidden"
            >
